...
// Side-by-side Fetches image URLs from backend if available, else shows local defaults.
export default function BeforeAfterImages({
  ...
  return (
    <div style={{ marginTop: 24, backgroundColor: "#372C2E", padding: 8, borderRadius: 8, overflowX: "clip" }}>
